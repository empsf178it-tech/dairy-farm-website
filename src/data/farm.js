export const FARM_METRICS = [
  { value: "120+", label: "Acres of Pasture", desc: "Green organic grazing pastures" },
  { value: "100%", label: "Single-Origin", desc: "Sourced exclusively from our farm" },
  { value: "0%", label: "Antibiotics & Hormones", desc: "Strict natural healthcare protocols" },
  { value: "4°C", label: "Instant Chilling", desc: "Chilled within 15 min of milking" }
];

export const ANIMAL_CARE_PILLARS = [
  {
    icon: "Utensils",
    title: "Organic Fodder & Clean Nutrition",
    desc: "Custom diet of fresh green fodder, napier grass, sorghum, and clover grown organically on our 120-acre land."
  },
  {
    icon: "Droplets",
    title: "Pure Mountain Spring Water",
    desc: "Continuous access to filtered, temperature-controlled natural spring water troughs in every shed."
  },
  {
    icon: "Home",
    title: "Spacious Open Housing",
    desc: "Rubber-matted soft beds, automated rotating massage brushes, and high-volume fan ventilation."
  },
  {
    icon: "HeartPulse",
    title: "24/7 Veterinary Oversight",
    desc: "Wearable IoT health collars track rumination, activity, and body temperature for proactive preventive care."
  },
  {
    icon: "Sun",
    title: "Natural Grazing & Free Pasture",
    desc: "Daily free pasture grazing under warm sunlight, promoting natural herd socializing and low stress."
  },
  {
    icon: "ShieldCheck",
    title: "Zero Hormones & Antibiotic-Free",
    desc: "Zero synthetic rBST hormones or preventive antibiotics. Milk from cows under medical recovery is strictly isolated."
  }
];
...
export const CORE_VALUES = [
  {
    id: "animal-care",
    title: "Animal Care Above All",
    subtitle: "Healthy animals come first",
    desc: "We believe true dairy excellence begins with how cows are treated every hour of every day. From free movement to natural pasture diets and soft bedding, compassion is our foundational principle.",
    details: [
      "Zero synthetic hormone injections or stress-inducing tethering",
  ...
  },
  {
    ...
    subtitle: "Every stage deserves attention",
    desc: "From the soil where our fodder grows to the steam sanitization of our glass bottles, we enforce strict 24-point quality controls without shortcutting.",
    details: [
      "Single-origin farm traceability for every single bottle",
  ...
  {
    id: "freshness",
    title: "Pure Farm Freshness",
    subtitle: "Protecting dairy quality from farm to home",
    desc: "Freshness isn't a marketing buzzword—it's a time window. We process and dispatch our morning milking on the very same day, reaching family tables within 12 to 18 hours.",
    details: [
      "Delivered within 24 hours of morning milking",
  ...
  },
  {
    ...
    subtitle: "Using resources responsibly for the future",
    desc: "We farm in harmony with nature by harnessing solar energy, recycling 100% of organic waste through bio-digesters, and eliminating single-use plastic packaging.",
    details: [
      "Over 1.2 Million single-use plastic pouches saved annually via reusable glass",
...
export const SUSTAINABILITY_STATS = [
  { value: "1.2M+", label: "Plastic Pouches Saved", desc: "Via reusable glass bottle return system" },
  { value: "4.5M", label: "Liters Water Harvested", desc: "Collected in farm recharge percolation ponds" },
  { value: "45%", label: "Solar & Bio Energy", desc: "Farm power sourced from clean renewable energy" },
  { value: "100%", label: "Organic Manure Loop", desc: "Bio-digestate piped back into green fodder soil" }
];

export const DAILY_LIFE_MOMENTS = [
  {
